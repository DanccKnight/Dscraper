...
cred = credentials.Certificate("/home/ansuman/Projects/Dscraper/serviceAccountKey.json")
firebase_admin.initialize_app(cred)
db = firestore.client()

web_url = 'https://ww4.readhaikyuu.com/manga/haikyuu/'
...
for link in chapter_links:
    try:
        ...
        db.collection('Haikyuu').document(chapter_text[index]).set(data)
